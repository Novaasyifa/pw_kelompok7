                            ...
                            <div class="relative p-4 max-w-lg w-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add new Category
                                        </h3>
                                        <button type="button"
                                    ...
                                    <!-- Modal body -->
                                    <form action="{{ route('create_category') }}" method="POST" class="p-4 md:p-5"
...
=======
                                <tr>
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center">
                                            <span onclick="window.location.href='/dashboard/categories/{{ $post->title }}'"
                                            ...
                                            <span
                                                onclick="window.location.href='/dashboard/categories/{{ $post->title }}/edit'"
