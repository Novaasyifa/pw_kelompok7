    ...
    <ul class="mt-4">
        <li class="mb-1 group">
            <a href="/dashboard"
                ...
                <span class="text-sm text-white font-medium ml-4">Dashboard</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="/dashboard/posts"
                ...
                <span class="text-sm text-white font-medium ml-4">My Post</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="/cetakBuku" target="_blank"
                ...
                <svg class="text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    height="18" width="18" fill="none" viewBox="0 0 16 20">
                ...
                <span class="text-sm text-white font-medium ml-4">Print To PDF</span>
            </a>
        </li>
    </ul>
