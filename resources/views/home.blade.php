        ...
        <div id="default-carousel" class="relative h-100 mx-20 my-200" data-carousel="slide">
            ...
            <div class="relative  h-56 overflow-hidden rounded-lg md:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="kmerchhub3/resources/views/images/seventeen.jpg"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Book">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/1200x400?Library"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Library">
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/1200x400?Comics"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Comics">
                </div>
                <!-- Item 4 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/1200x400?Novel"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Novel">
                </div>
                <!-- Item 5 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="https://source.unsplash.com/1200x400?Coffe"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Coffe">
                </div>
            </div>
            <!-- Slider indicators -->
    ...
    <form action="/" id="searchForm">
        ...
        <div class="relative">
            ...
            <input type="text" id="search" name="search"
                class="block w-full p-4 ps-10 text-sm rounded-lg form-control" placeholder="Search.....">
            <button type="submit"
                class="text-black absolute end-2.5 bottom-2.5 bg-[#FFCCAC] hover:bg-[#FFCCAC] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-[#FFCCAC] dark:hover:bg-[#FFCCAC] dark:focus:ring-[#FFCCAC] hover:text-white">Search</button>
        </div>
    </form>
    {{-- </section> --}}
    {{-- Akhir Search --}}
