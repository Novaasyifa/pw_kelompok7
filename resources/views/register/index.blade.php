...
<body>
    <div class="Registrasi">
        ...
        <div
            class="w-full mt-8 h-auto max-w-sm mx-auto p-3 bg-[#ffffff] border border-[#ffff] rounded-lg shadow sm:p-2 md:p-4  transform translate-y-20">
            <form action="/register" method="POST" class="max-w-md mx-auto">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="username" id="username"
                        class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-[#5d5d5d] appearance-none text-black  focus:outline-none focus:ring-0 focus:border-[#ffff] peer"
                        placeholder=" " @error('username') is-invalid @enderror value="{{ old('username') }}" />
                    <label for="floating_first_name"
                        class="peer-focus:font-medium absolute text-sm text-[#5d5d5d] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#5d5d5d] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Username</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input type="email" name="email" id="email"
                        class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-[#5d5d5d] appearance-none text-black focus:outline-none focus:ring-0 focus:border-[#ffff] peer"
                        placeholder=" " @error('email') is-invalid @enderror value="{{ old('username') }}" />
                    <label for="floating_email"
                        class="peer-focus:font-medium absolute text-sm text-[#5d5d5d] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#5d5d5d] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email
                        address</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_repeat_password"
                        class="peer-focus:font-medium absolute text-sm text-[#5d5d5d] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#5d5d5d] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Password</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input type="password" name="confirmPassword" id="floating_repeat_password"
                        class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-[#5d5d5d] appearance-none text-black focus:outline-none focus:ring-0 focus:border-[#ffff] peer"
                        placeholder=" " @error('confirmPassword') is-invalid @enderror />
                    <label for="floating_repeat_password"
                        class="peer-focus:font-medium absolute text-sm text-[#5d5d5d] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#5d5d5d] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Confirm
                        password</label>
                </div>
                ...
                <button type="submit"
                    class="w-full text-white hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-[#5d5d5d]  bg-[#1e1e1e] mb-4">
                    Register
                </button>

                <div class="text-sm font-medium text-[#1e1e1e] text-capasity-30">
                    Already registered? <a href="/login"
                        class="hover:underline hover:text-gray-600 text-black">Login</a>
                </div>
                <!-- <div class="flex flex-wrap items-center justify-center mt-4">
                    ...
                    <a href="{{ route('google-auth') }}"
                        ...
                        <img src="img/google.png" alt="" class="w-5 h-5 rounded block object-cover align-middle"> <span
                            class="ml-3 text-md"> Register with google</span>
                        {{-- </button> --}}
                    </a>
                </div> -->
            </form>
